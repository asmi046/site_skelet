...
Так же можно использовать без ссылки

```php
    <x-div-icon icon="fa-solid fa-door-open">Ссылка</x-div-icon>
```

В параметр icon предается Id иконки из ранее подключенного спрайта
